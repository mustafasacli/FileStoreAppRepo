...
namespace FileStoreAdmin.Source.Management
{
    internal class LogManager
    {
        ...
        private static void LogException2Db(LogEntry lg)
        {
            try
            {
        ...
        #endregion [ LogException2Db method ]
        ...
        public static void LogTransaction(string tableName, int userId, int entityId, string transactionType)
        {
            try
            {
                ...
                {
                    LogTime = DateTime.Now,
                    TableName = string.Format("Tbl{0}", tableName),
                    EntityId = entityId,
        ...
        #endregion [ LogTransaction method ]
        ...
        #endregion [ LogException2File method ]
        ...
        private static string getLogFile()
        {
            ...
            try
            {
                string errorFile = string.Format("error_{0}.log", DateTime.Now.ToString("yyyy_MM_dd"));
